...
%%%%%%% pxjahyper and minijs are not applicable for xelatex
%%\usepackage{pxjahyper}		% for shiori (document information in PDF)
%%\usepackage{minijs}			% non min10
%%% for using japanese %%%
...
プレゼントして一本のPDFを作ることにこだわらなくていいので，
